...
#endif
#include "../discord_components/d_nrp_macros.inc"
...
@discord() command:inv(@discord() cmd_params)
{
	...
	if(!strcmp(invtype, "shopitems"))
	{
		...
		GetInvData(id, "ProtectiveShield") ? ""d_reply" "d_protectiveshield" • **Protective Shield** (*ID: `13`*)\n" : ""
		);
...
#include "../discord_components/d_nrp_commands.inc"
#include "../discord_components/d_nrp_commands_mod.inc"
#include "../discord_components/d_nrp_utils.inc"
#include "../discord_components/d_nrp_funcs.inc"